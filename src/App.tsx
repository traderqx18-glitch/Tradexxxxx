    ...
    <div className="min-h-screen bg-[#0D0D0D] text-[#EAEAEA] font-sans flex flex-col justify-between selection:bg-[#00C076] selection:text-black relative overflow-x-hidden" id="main_app_wrapper">
      ...
      {!isLoggedIn ? (
        <div className="min-h-screen w-full bg-[#0D0D0D] text-[#EAEAEA] relative z-10 flex flex-col shrink-0" id="unauth_master_root">
          {unauthView === "landing" ? (
            <div className="flex flex-col min-h-screen bg-[#0D0D0D] overflow-x-hidden relative" id="landing_view_container">
              {/* Subtle CSS dynamic grid background overlay */}
              ...
              <div className="absolute top-0 right-1/4 w-96 h-96 rounded-full bg-[#00C97A]/3 blur-[120px] pointer-events-none z-0" />
              <div className="absolute bottom-1/4 left-1/4 w-96 h-96 rounded-full bg-[#00C97A]/2 blur-[120px] pointer-events-none z-10" />

              {/* Header Navigation */}
              <header className="relative z-20 border-b border-[#1F1F1F] bg-[#0D0D0D]/90 backdrop-blur-md" id="landing_header">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 flex items-center justify-between">
                  <div className="flex items-center gap-2 cursor-pointer" onClick={() => setUnauthView("landing")}>
                    <div className="relative flex items-center justify-center w-8 h-8 bg-[#00C97A]/10 border border-[#00C97A]/30 text-[#00C97A] rounded-lg shadow-sm">
                      <TrendingUp className="w-[18px] h-[18px]" strokeWidth={2.5} />
                    </div>
                    <div className="text-left">
                      <span className="font-sans font-black text-sm tracking-wider text-white block leading-none">TRADEX</span>
                      <span className="text-[8px] font-mono font-black block text-[#00C97A] tracking-widest leading-none mt-0.5 uppercase">BROKER</span>
                    </div>
                  </div>

                  {/* Desktop menu links */}
                  <nav className="hidden md:flex items-center gap-8 text-xs font-semibold tracking-wide text-gray-400">
                    <a href="#features_lbl" className="hover:text-white transition-colors">Features</a>
                    <a href="#markets_lbl" className="hover:text-white transition-colors">Markets</a>
                    <a href="#reviews_lbl" className="hover:text-white transition-colors">Reviews</a>
                    <a href="#how_lbl" className="hover:text-white transition-colors">How it Works</a>
                    <a href="#faq_lbl" className="hover:text-white transition-colors">FAQ</a>
                  </nav>
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="px-4 py-2 text-xs font-bold text-gray-300 hover:text-white border border-[#22304a]/60 hover:border-gray-500 rounded-lg transition-all cursor-pointer"
                    >
                      Login
                    </button>
                    <button
                      ...
                      className="px-4 py-2 text-xs font-bold bg-[#00C076] hover:bg-[#00A062] text-black rounded-lg transition-all shadow-md shadow-[#00C076]/10 cursor-pointer"
                    >
                      Open Account
                    </button>
                  </div>
              ...
              {/* Hero Section */}
              <section className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-16 md:pt-24 md:pb-28 text-center flex flex-col items-center justify-center space-y-6" id="landing_hero">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#00C076]/15 text-[#00C076] border border-[#00C076]/20 rounded-full text-[10px] font-bold tracking-wider uppercase font-sans">
                  <Award className="w-3.5 h-3.5" />
                  Regulated Global Derivatives Broker
                </div>
                <h1 className="text-4xl sm:text-6xl font-extrabold text-white tracking-tight leading-[1.1] font-sans max-w-3xl">
                  Trade Global Markets with <span className="text-[#00C076]">Instant Execution</span> Speed
                </h1>
                <p className="text-sm sm:text-lg text-gray-400 font-sans leading-relaxed max-w-2xl mx-auto">
                  Experience lightning-fast option contracts on Forex, Cryptocurrencies, Stocks, and OTC Markets. Up to 95% payouts in as short as 60 seconds with advanced protective vault protocols.
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 w-full sm:w-auto">
                  <button
                    id="btn_hero_cta_acc"
                    onClick={() => { setUnauthView("auth"); setActiveTab("register"); }}
                    className="w-full sm:w-auto px-8 py-3.5 text-sm font-bold bg-[#00C076] hover:bg-[#00A062] text-black rounded-xl transition-all shadow-lg hover:shadow-[#00C076]/20 flex items-center justify-center gap-2 cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    onClick={() => { setUnauthView("auth"); setActiveTab("login"); }}
                    className="w-full sm:w-auto px-8 py-3.5 text-sm font-bold bg-[#181818] hover:bg-[#1F1F1F] text-white border border-[#2E2E2E] hover:border-gray-500 rounded-xl transition-all flex items-center justify-center gap-2 cursor-pointer"
                  >
                ...
                <div className="pt-10 grid grid-cols-3 gap-8 border-t border-[#1F1F1F] max-w-md w-full mx-auto">
                  <div>
                    <span className="block text-xl sm:text-2xl font-black text-white">$10k</span>
                    <span className="text-[10px] text-gray-500 uppercase tracking-wider font-semibold">Demo Capital</span>
                  </div>
                  <div>
                    <span className="block text-xl sm:text-2xl font-black text-[#00C076]">95%</span>
                    <span className="text-[10px] text-gray-500 uppercase tracking-wider font-semibold">Max Payout</span>
                  </div>
                  <div>
                    <span className="block text-xl sm:text-2xl font-black text-white">24/7</span>
                    <span className="text-[10px] text-gray-500 uppercase tracking-wider font-semibold">Live Systems</span>
                  </div>
                </div>
              </section>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-12">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 text-left">
                    {[
                      ...
                      return (
                        <div key={idx} className="p-6 bg-[#121212] border border-[#1F1F1F] rounded-2xl space-y-4 hover:border-gray-755 transition-all">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-12">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left max-w-5xl mx-auto" id="reviews_grid_box">
                    {[
                      ...
                      <div key={idx} className="p-6 bg-[#121212] border border-[#1F1F1F] rounded-2xl space-y-4">
              ...
              {/* Footer */}
              <footer className="relative z-10 border-t border-[#1F1F1F] bg-[#0A0A0A] py-10 text-xs text-gray-500 font-sans" id="landing_footer">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div className="space-y-3 text-left">
                    <div className="flex items-center gap-2">
                      <div className="relative flex items-center justify-center w-6 h-6 bg-[#00C97A]/10 border border-[#00C97A]/30 text-[#00C97A] rounded shadow-sm">
                        <TrendingUp className="w-3.5 h-3.5" strokeWidth={2.5} />
                      </div>
                      <span className="font-bold text-white tracking-widest font-sans uppercase">TRADEX Markets</span>
                    </div>
                    <p className="max-w-md text-[11px] text-gray-500 leading-relaxed">
                  ...
                  <div className="md:text-right space-y-2">
                    ...
                    <div className="flex md:justify-end gap-4 font-mono text-[9px]">
                      <span>SECURE HANDSHAKE NODE ONLINE</span>
            ...
            <div className="min-h-screen grid grid-cols-1 md:grid-cols-12 bg-[#0D0D0D] font-sans w-full" id="split_auth_layout">
              {/* Left Panel: Live Market Intelligence Preview */}
              <div className="hidden md:flex md:col-span-5 bg-[#0A0A0A] border-r border-[#1F1F1F] flex-col justify-between p-8 relative overflow-hidden" id="auth_left_panel">
                {/* CSS animated glow overlay */}
                <div className="absolute bottom-1/4 left-1/4 w-72 h-72 rounded-full bg-[#00C97A]/4 blur-[100px] pointer-events-none" />

                <div className="space-y-3 text-left">
                  <div className="flex items-center gap-2 cursor-pointer" onClick={() => setUnauthView("landing")}>
                    <div className="relative flex items-center justify-center w-7 h-7 bg-[#00C97A]/10 border border-[#00C97A]/30 text-[#00C97A] rounded-lg shadow-md">
                      <TrendingUp className="w-4 h-4" strokeWidth={2.5} />
                    </div>
                    <span className="font-bold text-white font-sans tracking-wide">TRADEX Broker</span>
                  </div>
                </div>
        ...
        <div className="flex-1 flex flex-col justify-between h-screen max-h-screen overflow-hidden" id="dashboard_terminal">
          ...
          <header className="relative z-20 w-full bg-[#0b1329] border-b border-[#22304a] px-4 py-3 flex items-center justify-between shadow-md" id="dashboard_header">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2.5">
                <div className="p-2 bg-[#00C97A]/10 border border-[#00C97A]/30 rounded-lg flex items-center justify-center">
                  <TrendingUp className="w-4 h-4 text-[#00C97A]" />
                </div>
                <div>
                  <h1 className="font-sans font-black text-white text-base tracking-wider leading-none">TRADEX</h1>
                  <span className="text-[8px] font-sans font-bold block text-[#00C97A] tracking-widest leading-none mt-0.5 uppercase">BROKER</span>
                </div>
              </div>
          ...
          <div className="flex-1 flex flex-row overflow-hidden relative" id="tadex_main_terminal_body">
            ...
            <div className="flex-1 flex flex-col border-b md:border-b-0 border-[#22304a] bg-[#0c101d] relative z-20 overflow-hidden" id="chart_outer_container">
              ...
              <div className="flex-1 w-full relative overflow-hidden" id="trading_canvas_outer_box">
                <Chart
                  pair={activePair}
                  timeframe={timeframe}
                  chartType={chartType}
