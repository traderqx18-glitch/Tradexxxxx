...
window[window.TiktokAnalyticsObject]._li || (window[window.TiktokAnalyticsObject]._li = {}), window[window.TiktokAnalyticsObject]._li["CPC6SBRC77U2IO5KPOI0"] = "f5aacc7d-5b4d-11f1-9612-02001723488b";
window[window["TiktokAnalyticsObject"]]._cde = 390;;
if (!window[window["TiktokAnalyticsObject"]]._server_unique_id) window[window["TiktokAnalyticsObject"]]._server_unique_id = 'f5aaeb1e-5b4d-11f1-9612-02001723488b';
...
! function(e, n, i, d, o, t) {
    var u, M, a = l()._static_map || [{
        ...
        e = (l()._static_map = a, M = "https://analytics.tiktok.com/i18n/pixel/static/", null == (e = u = {
            "info": {
                "pixelCode": "CPC6SBRC77U2IO5KPOI0",
                "name": "TikTok_PO_Pixel",
                "status": 0,
                "setupMode": 0,
                "partner": "GoogleTagManagerClient",
                "advertiserID": "7355538873713262593",
                "advertiserVertical": 8,
                "is_onsite": false,
                ...
                "AutoConfig": {
                    ...
                    "vc_rules": {
                        "bit.ly": [{
                            "version": "stable",
                            "rule_key": "bit.ly",
                            "valueXpath": "//h2[contains(text(),'Belajar Strategi Ampuh Investasi Dengan Stock AI')]/following-sibling::p[2]/h2/small[1]",
                            "valueClass": "fw-bold",
                            "currency": {
                                "val": "Rp",
                                "xpath": "//h2[contains(text(),'Belajar Strategi Ampuh Investasi Dengan Stock AI')]/following-sibling::p[2]/h2/small[1]"
                            }
                        }],
                        "doubleclick.net": [{
                            "version": "stable",
                            "rule_key": "doubleclick.net",
                            "valueXpath": "//html",
                            "currency": {
                                "val": "N/A"
                            }
